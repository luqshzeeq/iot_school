...
// --- 5. Session Messages ---
// Retrieve and clear any success/error messages stored in the session (e.g., from a redirect).
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_user'])) {
    ...
    // Redirect back to the page, preserving filters.
    header("Location: " . $redirect_url);
    exit();
}

// --- 8. POST Handling (Delete User) ---
// Process form submission for deleting a teacher.
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_user'])) {
    ...
    } else if ($user_id_to_delete == $_SESSION['user_id']) { // Prevent admin from deleting their own account.
...
<?php include 'header.php'; // Includes <DOCTYPE html>, <html>, <head>, <body>, and the common header with dropdown ?>
    ...
    <!-- However, if header.php defines a placeholder title, you can override it here if this page is loaded directly. -->
