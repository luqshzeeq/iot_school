...
// !!! IMPORTANT: THIS API KEY MUST MATCH THE apiKey IN YOUR ESP32 CODE !!!
$API_KEY = "ESP32_SECRET_KEY"; // <<< ENSURE THIS MATCHES THE ESP32 CODE

// Include your database connection file
include 'db_connection.php';

// --- FOR DEBUGGING: Enable all error reporting. REMOVE THIS ON PRODUCTION. ---
// This is critical for seeing detailed PHP errors if something goes wrong.
...
// The parameter name is now 'api_key' to match ESP32
if (empty($_POST['api_key']) || $_POST['api_key'] !== $API_KEY) { // <<< NOW CHECKING 'api_key'
